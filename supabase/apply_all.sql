...
-- =============================================================================
-- "I'm Back" — coach returns from travel (SECURITY DEFINER).
-- Lets a read-only coach clear their own travel block and alert admins without
-- loosening RLS. Source: CURSOR_CONTEXT.md "Key Business Logic" — Im Back.
-- =============================================================================
