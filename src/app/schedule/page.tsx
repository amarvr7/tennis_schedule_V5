...
export const metadata = {
  title: "My Schedule · IMG Academy Tennis",
};
...
const GROUP_TINT: Record<SessionType, string> = {
  competitive: "bg-rose-50 text-rose-700 dark:bg-rose-950/60 dark:text-rose-300",
  developmental: "bg-sky-50 text-sky-700 dark:bg-sky-950/60 dark:text-sky-300",
  foundational: "bg-emerald-50 text-emerald-700 dark:bg-emerald-950/60 dark:text-emerald-300",
  camp: "bg-amber-50 text-amber-700 dark:bg-amber-950/60 dark:text-amber-300",
  adults: "bg-violet-50 text-violet-700 dark:bg-violet-950/60 dark:text-violet-300",
  legacy: "bg-violet-50 text-violet-700 dark:bg-violet-950/60 dark:text-violet-300",
  pro: "bg-fuchsia-50 text-fuchsia-700 dark:bg-fuchsia-950/60 dark:text-fuchsia-300",
  bt: "bg-orange-50 text-orange-700 dark:bg-orange-950/60 dark:text-orange-300",
  travel: "bg-cyan-50 text-cyan-700 dark:bg-cyan-950/60 dark:text-cyan-300",
  saturday: "bg-teal-50 text-teal-700 dark:bg-teal-950/60 dark:text-teal-300",
};
...
const SchedulePage = async ({ searchParams }: { searchParams: SearchParams }) => {
  ...
  return (
    <main className="mx-auto flex max-w-3xl flex-col gap-5 p-6 sm:p-8">
      ...
      {traveling ? (
        <section className="flex flex-col items-start justify-between gap-3 rounded-lg bg-cyan-50 p-4 ring-1 ring-cyan-200 dark:bg-cyan-950/40 dark:ring-cyan-800/50 sm:flex-row sm:items-center">
          <div className="flex items-start gap-2.5">
            <span className="mt-0.5 text-cyan-600 dark:text-cyan-400">
              <HugeiconsIcon icon={AirplaneTakeOff01Icon} aria-hidden="true" />
            </span>
            <div>
              <p className="text-sm font-semibold text-cyan-900 dark:text-cyan-100">You&rsquo;re marked as traveling</p>
              <p className="text-xs text-cyan-800 dark:text-cyan-300/90">
